...
(function ($) {
	...
	if ($('span').hasClass('custom-mobile-menu-title')) {
		...
		if ($('body').hasClass('home')) {
			...
			else if ($('h1').hasClass('resto-title')) {
				current = $('h1.resto-title').html();
			}
			
			else if ($('h1').hasClass('title-categ')) {
				current = $('h1.title-categ').html();
			}
			else if ($('h1').hasClass('loc-title')) {
				current = $('h1.loc-title').html();
			}
			else if ($('h2').hasClass('category_title')) {
				current = $('h2.category_title').html();
			}
			else if ($('h4').hasClass('category_title')) {
				current = $('h4.category_title').html();
			}
